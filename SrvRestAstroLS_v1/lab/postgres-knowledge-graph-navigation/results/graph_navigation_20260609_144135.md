...
- **Nodos visitados:** 8 (useful_diagnosis, planned_extension, automatable, commercial_limits, concrete_orientation, sales_diagnosis, sellable_today, minimum_slots)
...
- **Nodos visitados:** 3 (commercial_limits, whatsapp_handoff, planned_extension)
- **Caminos encontrados:** 2
- **Esperados encontrados:** 2/2 → commercial_limits, planned_extension
...
- **Nodos visitados:** 3 (commercial_limits, planned_extension, step_to_action)
- **Caminos encontrados:** 2
- **Esperados encontrados:** 2/2 → commercial_limits, planned_extension
...
- **Nodos visitados:** 8 (planned_extension, automatable, commercial_limits, concrete_orientation, chunk_offer_decision, sales_diagnosis, sellable_today, useful_diagnosis)
- **Caminos encontrados:** 7
...
- **Nodos visitados:** 3 (commercial_limits, chunk_offer_decision, planned_extension)
- **Caminos encontrados:** 2
- **Esperados encontrados:** 2/2 → commercial_limits, planned_extension
...
- **Score:** +2
- **Dirección:** forward, max_depth=4
- **Nodos visitados:** 15 (useful_diagnosis, planned_extension, automatable, knowledge_base_service, commercial_limits, knowledge_scope_sales_diagnosis, concrete_orientation, access_tags...)
- **Caminos encontrados:** 14
- **Esperados encontrados:** 3/3 → cross_customer_isolation, access_tags, metadata_auditability
...
- **Score:** +2
- **Dirección:** forward, max_depth=3
- **Nodos visitados:** 4 (package_sales_diagnosis, cross_customer_isolation, knowledge_scope_sales_diagnosis, sales_diagnosis)
...
- **Nodos visitados:** 6 (useful_diagnosis, commercial_limits, concrete_orientation, package_sales_diagnosis, sales_diagnosis, minimum_slots)
- **Caminos encontrados:** 5
- **Esperados encontrados:** 5/5 → commercial_limits, concrete_orientation, minimum_slots, sales_diagnosis, useful_diagnosis
...
- **Score:** +2
- **Dirección:** backward, max_depth=4
- **Nodos visitados:** 4 (whatsapp_handoff, planned_extension, lead_capture, commercial_limits)
- **Caminos encontrados:** 3
- **Esperados encontrados:** 2/2 → commercial_limits, planned_extension

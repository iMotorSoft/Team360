...
const profileDefinitions: Record<MockProfileId, MockProfileDefinition> = {
  ...
  team360_operator: {
    ...
    accessibleOrganizationIds: ["org-team360", "org-team360-live", "org-carmel-retail", "org-netzaj-racing"],
    accessibleWorkspaceIds: ["ws-team360-control", "ws-team360-live-public-site", "ws-carmel-retail", "ws-netzaj-marketplace"],
    effectivePermissions: [
      "workspaces.read",
      "workspaces.switch",
      "services.read",
  ...
  client_admin: {
    ...
    userId: "user-team360-live-admin",
    defaultWorkspaceId: "ws-team360-live-public-site",
    accessibleOrganizationIds: ["org-team360-live"],
    accessibleWorkspaceIds: ["ws-team360-live-public-site"],
    effectivePermissions: [
      "workspaces.read",
      "services.read",
      "reports.read",

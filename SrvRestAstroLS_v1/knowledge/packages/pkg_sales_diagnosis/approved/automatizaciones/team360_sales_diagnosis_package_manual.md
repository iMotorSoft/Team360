...
topic_key: diagnostico_automatizacion
node_path: "/automatizaciones/diagnostico-automatizacion"
title: "Manual del paquete de diagnostico de automatizacion"
visibility: public
client_code:
...
approval_notes: >
  Primera copia approved controlada del manual del paquete
  pkg_sales_diagnosis para validar scanner dry-run y candidatura
  de ingesta. Mantiene Step-to-Action, lead capture, diagnostic_code
  y WhatsApp handoff como planned_extension/futuras capacidades.
---

# Manual del paquete de diagnóstico de automatización

> Estado approved: primera copia controlada para validar el scanner dry-run
> como candidato de ingesta. No activa persistencia DB, chunks, embeddings,
> ArangoDB, Milvus ni SemanticChunker.

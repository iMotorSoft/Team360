...
- [[lat-documentation-policy]] — política permanente para estructura Markdown, enlaces wiki, índice LAT, archivos de estado y gates documentales.
...
- [[team360-runtime-operational-policy]] — Validated public Vera runtime policy: `/t360` -> Litestar -> PostgreSQL 18 -> Milvus 2.6 -> LiteLLM Chat Completions -> `openai_gpt-5.4-nano`, including ports, env vars, frontend URL ownership, secrets policy and smoke validation rules.

...
- [[browser-mcp-validation-policy]] — Browser MCP / opencode-browser validation policy: backend 7050 and Astro 3050 preconditions, allowed restart of local app servers, mandatory stop on Browser MCP failure and evidence boundaries.
